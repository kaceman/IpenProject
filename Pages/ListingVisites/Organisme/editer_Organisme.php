<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if ($_GET['fonction'] == 'editer') {
            ...
            $sql = "SELECT * FROM organisme WHERE id__organisme='$id'";
            ...
            $sql = "DELETE FROM organisme WHERE id__organisme='$id'";
        ...
        $obj = new Organisme($code, $organisme, $medecin, $specalite, $dateVisite, $a, $b, $c, $remarque, $region);
